        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-light text-zinc-400 mb-4 tracking-wide">
              Complete Smart Contract Verification Platform
            </p>
            <p className="text-base md:text-lg text-zinc-500 max-w-2xl mx-auto mb-12 leading-relaxed">
              From code to cryptographic attestation. Write specifications, run formal verification,
              and publish on-chain proof that your contracts meet their security requirements.
            </p>
          ...
          >
            <div>
              ...
              <div className="space-y-6 text-zinc-400 leading-relaxed">
                <p>
                  VeriPro is a complete verification platform that takes your smart contracts from source code to on-chain attestation. <span className="text-white">Import from GitHub, upload files, or paste code directly</span> into our workspace.
                </p>
                <p>
                  Write formal specifications, run the symbolic executor, and receive cryptographic proof that your contracts meet their security requirements.
                </p>
              </div>

              <div className="mt-8 grid grid-cols-2 gap-8">
                <div>
                  <div className="text-2xl font-light mb-2 text-white">Workspace</div>
                  <div className="text-sm text-zinc-500">GitHub, uploads, or direct input. Your choice.</div>
                </div>
                <div>
                  <div className="text-2xl font-light mb-2 text-white">Attestation</div>
                  <div className="text-sm text-zinc-500">On-chain proof of verified properties.</div>
                </div>
              </div>
            </div>
            <div>
