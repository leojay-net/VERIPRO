...
VeriPro is a full-stack formal verification platform for Ethereum smart contracts. It combines a powerful symbolic execution engine (CBSE) with an intuitive web interface, enabling developers to mathematically prove their contracts are correct for all possible inputs—not just the ones they test.
...
### Frontend (`cbse-frontend/`)

The VeriPro web interface built with Next.js 16, React 19, and Tailwind CSS.

#### Features

- Project management dashboard
- Syntax-highlighted Solidity editor
- AI-powered specification generation (Gemini)
- Real-time verification results
- Wallet integration (RainbowKit + wagmi)
- On-chain attestation commitment
...
The on-chain attestation registry deployed on Mantle Network.
...
5. **Commit On-Chain** - Publish attestation to Mantle (optional)
